<?php
class Magecomp_Fileupload_Block_Adminhtml_Productcats_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
		...
		$statuses = array();
        $statuses = Magecomp_Fileupload_Model_Status::getOptionArray();
