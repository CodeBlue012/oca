 ...
 */
class Plugincompany_Couponimport_Block_Adminhtml_Promo_Quote_Coupons_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor
     */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('couponimport/index/exportCouponsCsv', Mage::helper('customer')->__('CSV'));
        $this->addExportType('couponimport/index/exportCouponsXml', Mage::helper('customer')->__('Excel XML'));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             ...
             'url'  => $this->getUrl('couponimport/index/couponsMassDelete', array('_current' => true)),
    ...
    {
        return $this->getUrl('couponimport/index/couponsGrid', array('_current'=> true));
    }
