...
class Plugincompany_Cmsrevisions_Block_Adminhtml_Blockrevisions extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('block_revision_date', array(
            'header'    => Mage::helper('catalog')->__('Revision Date'),
            'width'     => 100,
        ...
        $this->addColumn('block_username', array(
            'header'    => Mage::helper('catalog')->__('Revision By'),
            'sortable'  => true,
            'width'     => 60,
            'index'     => 'username'
        ));
    ...
    {
        return $this->getUrl('adminhtml/revisions/viewblockrevisions', array('_current'=>true));
    }
