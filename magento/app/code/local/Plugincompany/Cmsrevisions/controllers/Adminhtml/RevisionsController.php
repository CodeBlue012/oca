 ...
 *
 * Class Plugincompany_Cmsrevisions_Adminhtml_RevisionsController
 */
class Plugincompany_Cmsrevisions_Adminhtml_RevisionsController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Page revisions grid
     *
