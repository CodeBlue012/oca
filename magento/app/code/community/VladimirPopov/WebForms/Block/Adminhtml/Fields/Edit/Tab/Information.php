    ...
    extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $hidden_value = $fieldset->addField('value_hidden','textarea',array(
            ...
            'name' => 'value[hidden]',
            'note' => Mage::helper('webforms')->__("You can use PHP tags to execute simple scripts. Example:<br><i>&lt;?php if(Mage::registry('product')) echo Mage::registry('product')->getName();?&gt;</i>")
        ));
