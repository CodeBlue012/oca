...
/**
 * Perficient_GoogleTagManager_Model_Orderanalytics
 *
 * @category  Perficient
 * @package   Perficient_GoogleTagManager
 * @author    Perficient <mukesh.soni@perficient.com>
 ...
 * @link      http://shop.perficient.com/extensions/google-tag-manager-by-perficient
 */
class Perficient_GoogleTagManager_Model_Orderanalytics extends Mage_Core_Model_Abstract
{
    ...
    {
        parent::_construct();
        $this->_init('perficient_googletagmanager/orderanalytics');
    }
